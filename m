Return-Path: <ecryptfs+bounces-1017-lists+ecryptfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+ecryptfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QCHVFOmypmn9SgAAu9opvQ
	(envelope-from <ecryptfs+bounces-1017-lists+ecryptfs=lfdr.de@vger.kernel.org>)
	for <lists+ecryptfs@lfdr.de>; Tue, 03 Mar 2026 11:07:37 +0100
X-Original-To: lists+ecryptfs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE801EC5EA
	for <lists+ecryptfs@lfdr.de>; Tue, 03 Mar 2026 11:07:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 14CBC3095413
	for <lists+ecryptfs@lfdr.de>; Tue,  3 Mar 2026 10:05:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 87334382368;
	Tue,  3 Mar 2026 10:05:19 +0000 (UTC)
X-Original-To: ecryptfs@vger.kernel.org
Received: from metis.whiteo.stw.pengutronix.de (metis.whiteo.stw.pengutronix.de [185.203.201.7])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4D4A1390C90
	for <ecryptfs@vger.kernel.org>; Tue,  3 Mar 2026 10:05:17 +0000 (UTC)
...
X-Spamd-Result: default: False [-1.06 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-1017-lists,ecryptfs=lfdr.de];
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[mkl@pengutronix.de,ecryptfs@vger.kernel.org];
