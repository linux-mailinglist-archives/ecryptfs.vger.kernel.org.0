Return-Path: <ecryptfs+bounces-1057-lists+ecryptfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+ecryptfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kOkGJbD9pmkKcAAAu9opvQ
	(envelope-from <ecryptfs+bounces-1057-lists+ecryptfs=lfdr.de@vger.kernel.org>)
	for <lists+ecryptfs@lfdr.de>; Tue, 03 Mar 2026 16:26:40 +0100
X-Original-To: lists+ecryptfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 2810C1F28F5
	for <lists+ecryptfs@lfdr.de>; Tue, 03 Mar 2026 16:26:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 9D27330D36DB
	for <lists+ecryptfs@lfdr.de>; Tue,  3 Mar 2026 15:18:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ED78B481674;
	Tue,  3 Mar 2026 15:18:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=mit.edu header.i=@mit.edu header.b="KzTSOHRw"
X-Original-To: ecryptfs@vger.kernel.org
Received: from outgoing.mit.edu (outgoing-auth-1.mit.edu [18.9.28.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AE80548124E
	for <ecryptfs@vger.kernel.org>; Tue,  3 Mar 2026 15:18:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=18.9.28.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1772551112; cv=none; b=J92n5QpvVbi3dvOIwdLpYwcg9/S2eZ2Bkf3oK9SEiz8+dN/aBiUbyRQ5RQM35V2QKHvS+XGWsBeXboO6znahEIJbIVl2dMIeceByu6+vZfqTvpNGiYSmufsPMi5Y97Z9mm3lJ6RqceboaioMKBiJRv3wwRxGGc50iObF5P/kWhA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1772551112; c=relaxed/simple;
	bh=lwqjyYch6vh3dzuCIh22Ma60E3/UVejNtUUWdK+HCIs=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=ElfLayM2Cn+qylCry32WxRmlXa+xsRH3xjmcazl0aGqrTqu/KZS3fhCyzhZXxs1oxLjjC80wz1AnWPE+xkvtzoIn1futuhk1PvZpFArmGRF8WJaBqc6GX+E6IZqUKT3X9bMstjMbNR2IJUtFHvGyPzZCfoszr8qZECOHSESqBIU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=mit.edu; spf=pass smtp.mailfrom=mit.edu; dkim=pass (2048-bit key) header.d=mit.edu header.i=@mit.edu header.b=KzTSOHRw; arc=none smtp.client-ip=18.9.28.11
...
X-Spamd-Result: default: False [-0.66 / 15.00];
 ...
 rg];
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-1057-lists,ecryptfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	FROM_NEQ_ENVFROM(0.00)[tytso@mit.edu,ecryptfs@vger.kernel.org];
